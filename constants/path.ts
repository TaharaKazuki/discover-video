...
export const YOUTUBE_REQUEST_URL = (searchQuery: string, apiKey: string) =>
  `https://youtube.googleapis.com/youtube/v3/search?part=snippet&type=video&maxResults=25&q=${searchQuery}&key=${apiKey}`
